      ...
      <el-container>
        <el-aside width="600px">
          <el-form :inline="true" :model="formInline" class="demo-form-inline">
            ...
            <el-form-item>
              <el-button type="primary" @click="findName(formInline.user)"
                >查询</el-button
              >
            </el-form-item>
          </el-form>
          <span>歌曲类型:</span>
          <el-button type="text" @click="Songfind()">全部</el-button>
          <el-button type="text" @click="findSongByCategory('流行')"
            >流行</el-button
          >
          <el-button type="text" @click="findSongByCategory('欧美')"
            >欧美</el-button
          >
          <el-button type="text" @click="findSongByCategory('华语')"
            >华语</el-button
          >
          <el-button type="text" @click="findSongByCategory('摇滚')"
            >摇滚</el-button
          >
...
export default {
  ...
  methods: {
    ...
    findSongByCategory(category) {
      SongFindCategoryApi(category)
        .then((res) => {
          if (res.status === 200) {
